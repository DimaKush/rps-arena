 ...
 *
 * This script generates the file containing the contracts Abi definitions for Hardhat 2.
 * This is a fallback script that uses the old hardhat-deploy system.
